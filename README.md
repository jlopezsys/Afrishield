...
[**▶ Live demo**](https://jlopesys.github.io/afrishield) · [Report an issue](https://github.com/jlopesys/afrishield/issues)
...
| Tool | What it does |
|------|--------------|
| **▦ SOC Dashboard** | Live-style ops view: severity counts, rolling alert feed, throughput, MTTD/MTTR *(demo data)* |
